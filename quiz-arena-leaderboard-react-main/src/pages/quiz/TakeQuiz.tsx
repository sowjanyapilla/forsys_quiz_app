...
//       if (!document.fullscreenElement && quizStarted && document.visibilityState === "visible") {
//         setFullscreenExitCount((prev) => {
//           const next = prev + 1;
//           if (next >= 3) {
//             toast({ title: "Quiz Ended", description: "Exited fullscreen too many times.", variant: "destructive" });
//             handleSubmitQuiz();
//           } else {
//             toast({ title: "Warning", description: `Fullscreen required. Attempt ${next}/3.`, variant: "destructive" });
...
//         <CardHeader className="border-b border-blue-100 bg-indigo-50 rounded-t-xl px-8 pt-6 pb-4">
...
//             <h2 className="text-lg font-semibold text-indigo-700 mb-2">Before You Begin</h2>
//             <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
//               <li>This quiz is time-bound. It will auto-submit when time ends.</li>
//               <li>Stay in fullscreen mode. You may exit a maximum of 2 times.</li>
//               <li>Some questions have their own timers.</li>
//               <li>Answer all questions for a better score.</li>
//             </ul>
//           </div>
...
//               className="bg-indigo-600 hover:bg-indigo-700 text-white text-base font-medium px-6 py-2 rounded-md transition duration-300 shadow-md"
//             >
//               Start Quiz
//             </Button>
//           </div>
...
//         <Card
//   className="border border-blue-200 shadow-lg bg-white rounded-xl select-none"
//   onContextMenu={(e) => e.preventDefault()}
// >

//   <CardHeader className="bg-indigo-50 border-b border-blue-100 rounded-t-xl px-6 py-4">
//     <CardTitle className="text-xl font-bold text-indigo-700 select-none">
...
//       onValueChange={(val) => handleAnswerChange(currentQuestionIndex.toString(), parseInt(val))}
//     >
//       {currentQuestion.options.map((opt, idx) => (
//         <div
//           key={idx}
//           className="flex gap-2 p-2 border border-gray-200 rounded-md hover:bg-blue-50 transition-colors"
//         >
//           <RadioGroupItem value={idx.toString()} id={`opt-${idx}`} />
//           <Label htmlFor={`opt-${idx}`} className="cursor-pointer text-gray-800">
//             {opt}
//           </Label>
//         </div>
//       ))}
...
//             <Button
//               ref={(el) => el && showResumeModal && el.focus()}
//               onClick={() => {
...
//               Please share any thoughts about your quiz experience (optional).
//             </p>
//             <textarea
//               value={feedbackText}
//               onChange={(e) => setFeedbackText(e.target.value)}
//               placeholder="Type your feedback here..."
//               className="w-full p-2 rounded border border-gray-300 dark:border-gray-700 dark:bg-gray-800 text-gray-900 dark:text-white mb-4"
//               rows={4}
//             />
...
const TakeQuiz = () => {
  ...
  useEffect(() => {
    ...
    const handleFullscreenChange = () => {
      if (!document.fullscreenElement && quizStarted && document.visibilityState === "visible") handleViolation();
    };
